  ...
  Future<CourseClassesModel?> coursesClasses({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint(
            "Failed to fetch course classess: ${response.statusCode}");
        return null;
      }
    } catch (e) {
    ...
    // fuction to fetch course chapters
  Future<CourseChapterModel?> coursesChapter({
    required BuildContext context,
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse == null || jsonResponse.isEmpty) {
          ...
          if (courseChapterModel.type == 'success') {
            ...
            showSnackbar(context, courseChapterModel.type!);
            return null;
          }
        }
      } else {
