...
class _PdfViewerState extends State<PdfViewer> {
  ...
  @override
  void initState() {
     context.read<BookmarkProvider>().checkBookMark(context: context, contentid: widget.contentId, type: 'materials');
    super.initState();
  }
        ...
        actions: [
          IconButton(
                        onPressed: bookmarkProvider.isLoading ? null : () async{
                          await context.read<BookmarkProvider>().makeBookMark(context: context, contentid:widget.contentId, type: 'materials');
                        },
