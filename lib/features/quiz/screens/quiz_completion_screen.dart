        ...
        child: SizedBox(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                //lottie
                Lottie.asset('assets/lottie/succesful_lottie.json',width: MediaQuery.of(context).size.width * .5,),
                              ...
                              mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  ...
                                  Container(
                                    ...
                                    SizedBox(width: 10,),
                                    Text("Correct",style: TextStyle(color:AppColor.greenStroke ,fontWeight: FontWeight.w300),),
                                ],
                              ),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    SizedBox(width: 10,),
                                  Text("wrong",style: TextStyle(color:AppColor.greyText ,fontWeight: FontWeight.w300),),
                                ],
                              ),
