...
class _DreamCoinsState extends State<DreamCoins> {
  ...
  final List<Map<String, String>> qaList = [
  {
    ...
    "answer": "DreamCoin is a virtual wallet coin you earn by participating in the daily UPSC Target Quiz. It encourages consistency and rewards learning."
  },
  {
  ...
  },
  {
    ...
    "answer": "Once you reach the minimum redeemable amount, you can request a withdrawal to your linked bank account directly from the app."
  },
];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Stack(children: [                        //parabolic bg stack
              CustomPaint(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(                                          //available dreamcon section   
                      ...
                      Padding(                                    //swipable button
                        ...
                        child: SlideAction(
                          ...
                          elevation: 5,
                          onSubmit: () {
                            //  Perform the action after sliding     
                          },
                        ),
                      ),
                      SizedBox(
            ...
            Padding(                                      // reward history section
                      ...
                      (index) {
                        ...
                        if (historyList['type'] == 'reward') {          // row for rewards
                         ...
                         return Padding(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  child: Row(
                                    children: [
                                      Image.asset("assets/icons/rupee.png", width: 30,),
                                      SizedBox(width: 13,),
                                      Expanded(
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text(historyList['name']!,style: TextStyle(color: AppColor.secondaryColor),),
                                            Text(historyList['date']!,style: TextStyle(fontWeight: FontWeight.w300,fontSize: 13,color: AppColor.secondaryColor))
                                          ],
                                        ),
                                      ),
                                      ],
                                ...
                                SizedBox(width: 10,),
                                  Row(
                                    children: [
                                      Image.asset("assets/icons/star.png",width: 20,),
                                      SizedBox(width: 5,),
                                      Text(historyList['amt']!,style: TextStyle(color: AppColor.secondaryColor,fontWeight: FontWeight.w500))
                                    ],
                                  ),
                          ...
                          return Padding(                        // row for purchase
                            padding: const EdgeInsets.all(5.0),
                            child: Row(
                              children: [
                                Expanded(
                                  child: Row(
                                    children: [
                                      Image.asset("assets/icons/shopping-card.png", width: 30,),
                                      SizedBox(width: 13,),
                                      Expanded(
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                ...
                                SizedBox(width: 10,),
                                  Row(
                                    children: [
                                      ...
                                      Image.asset("assets/icons/star.png",width: 20,),
                                      SizedBox(width: 5,),
                                      Text(historyList['amt']!,style: TextStyle(color: AppColor.redStroke,fontWeight: FontWeight.w500))
                                    ],
                                  ),                                  
                              ],
                            ),
